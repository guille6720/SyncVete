-- Data Import/Export Phase 28: whatsapp_messages export. EXPORT ONLY.
-- No import of WhatsApp messages (never re-send / never recreate notification side-effects).
...
COMMENT ON CONSTRAINT data_export_jobs_export_type_check ON public.data_export_jobs IS
  'Phase 28: whatsapp_messages export-only. No WhatsApp import / no auto-send.';
