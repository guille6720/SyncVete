-- Data Import/Export Phase 14: appointments import + provenance + integrity/prune coverage.
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_appointments_org_source_unique
  ON public.appointments (organization_id, source_system, source_record_id)
...
CREATE INDEX IF NOT EXISTS idx_appointments_import_batch
  ON public.appointments (import_batch_id)
  WHERE import_batch_id IS NOT NULL;

-- Refresh integrity orphan coverage (includes appointments).
...
-- Extend prune to appointments (replace phase 13 body).
