-- Data Import/Export Phase 24: cash_sessions export (with movements). EXPORT ONLY.
-- No import of cash sessions/movements (never reopen caja / never call register_payment).
...
COMMENT ON CONSTRAINT data_export_jobs_export_type_check ON public.data_export_jobs IS
  'Phase 24: cash_sessions export-only (sessions + movements). No cash import.';
