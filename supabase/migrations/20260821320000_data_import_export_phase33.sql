-- Data Import/Export Phase 33: notifications export. EXPORT ONLY.
-- No import of in-app notifications (never recreate inbox noise / never auto-notify).
...
COMMENT ON CONSTRAINT data_export_jobs_export_type_check ON public.data_export_jobs IS
  'Phase 33: notifications export-only. No notification import / no auto-notify.';
