-- Data Import/Export Phase 27: reminder_logs export. EXPORT ONLY.
-- No import of reminder logs (never auto-send WhatsApp / never recreate notification side-effects).
...
COMMENT ON CONSTRAINT data_export_jobs_export_type_check ON public.data_export_jobs IS
  'Phase 27: reminder_logs export-only (CRM history). No reminder import / no auto-send.';
