-- Data Import/Export Phase 34: staff_profiles export (profiles + branch_members). EXPORT ONLY.
-- No import of staff/auth users (never create auth.users / never change roles via migration import).
...
COMMENT ON CONSTRAINT data_export_jobs_export_type_check ON public.data_export_jobs IS
  'Phase 34: staff_profiles export-only (profiles + memberships). No staff/auth import.';
